...
class Destination_calcule:
    ...
    def __init__(self):
        ...
        self.destinations_courte = [
            ...
            Destination(Ville.SouthBayMouth, Ville.Buffalo______, 6, 87),
            Destination(Ville.Buffalo______, Ville.NewYork______, 6, 94),
            ...
            Destination(Ville.GreenBay_____, Ville.Buffalo______, 11, 63),
            ...
            Destination(Ville.SouthBayMouth, Ville.Montreal_____, 14, 79),
